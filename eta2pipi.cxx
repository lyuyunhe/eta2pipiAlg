...
StatusCode eta2pipi::initialize() {
  ...
  if (nt1)
    ...
    if (m_anaTuple) { // McTruth Information
      ...
      status = m_anaTuple->addItem("kmfit5C_lab_pip_mom", m_kmfit5C_lab_pip_mom);
      ...
      status = m_anaTuple->addItem("kmfit5C_lab_pim_mom", m_kmfit5C_lab_pim_mom);

      status = m_anaTuple->addItem("kmfit5C_lab_Etagam_e", m_kmfit5C_lab_Etagam_e);
      status = m_anaTuple->addItem("kmfit5C_lab_Etagam_px", m_kmfit5C_lab_Etagam_px);
      status = m_anaTuple->addItem("kmfit5C_lab_Etagam_py", m_kmfit5C_lab_Etagam_py);
      status = m_anaTuple->addItem("kmfit5C_lab_Etagam_pz", m_kmfit5C_lab_Etagam_pz);
      status = m_anaTuple->addItem("kmfit5C_lab_Etagam_mom", m_kmfit5C_lab_Etagam_mom);

      status = m_anaTuple->addItem("kmfit5C_lab_Jpsigam_e", m_kmfit5C_lab_Jpsigam_e);
      status = m_anaTuple->addItem("kmfit5C_lab_Jpsigam_px", m_kmfit5C_lab_Jpsigam_px);
      status = m_anaTuple->addItem("kmfit5C_lab_Jpsigam_py", m_kmfit5C_lab_Jpsigam_py);
      status = m_anaTuple->addItem("kmfit5C_lab_Jpsigam_pz", m_kmfit5C_lab_Jpsigam_pz);
      status = m_anaTuple->addItem("kmfit5C_lab_Jpsigam_mom", m_kmfit5C_lab_Jpsigam_mom);
//kmfit5C cms
      ...
      status = m_anaTuple->addItem("kmfit5C_cms_pim_mom", m_kmfit5C_cms_pim_mom);
      ...
      status = m_anaTuple->addItem("kmfit5C_cms_pip_mom", m_kmfit5C_cms_pip_mom);
      status = m_anaTuple->addItem("kmfit5C_cms_Etagam_e", m_kmfit5C_cms_Etagam_e);
      status = m_anaTuple->addItem("kmfit5C_cms_Etagam_px", m_kmfit5C_cms_Etagam_px);
      status = m_anaTuple->addItem("kmfit5C_cms_Etagam_py", m_kmfit5C_cms_Etagam_py);
      status = m_anaTuple->addItem("kmfit5C_cms_Etagam_pz", m_kmfit5C_cms_Etagam_pz);
      status = m_anaTuple->addItem("kmfit5C_cms_Etagam_mom", m_kmfit5C_cms_Etagam_mom);
      // dE/dx
