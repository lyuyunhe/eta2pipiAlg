...
#cmt_local_tagfile = $(eta2pipiAlg_tag).make
cmt_local_tagfile = $(bin)$(eta2pipiAlg_tag).make
...
cmt_local_setup_eta2pipiAlg = $(bin)setup_eta2pipiAlg$$$$.make
...
eta2pipiAlg_extratags = -tag_add=target_eta2pipiAlg

#$(cmt_local_tagfile_eta2pipiAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_eta2pipiAlg) ::
else
$(cmt_local_tagfile_eta2pipiAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_eta2pipiAlg); then /bin/rm -f $(cmt_local_tagfile_eta2pipiAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_eta2pipiAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_eta2pipiAlg)"; \
	  test ! -f $(cmt_local_setup_eta2pipiAlg) || \rm -f $(cmt_local_setup_eta2pipiAlg); \
	  trap '\rm -f $(cmt_local_setup_eta2pipiAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_extratags) show setup >$(cmt_local_setup_eta2pipiAlg) && \
	  if [ -f $(cmt_final_setup_eta2pipiAlg) ] && \
	    \cmp -s $(cmt_final_setup_eta2pipiAlg) $(cmt_local_setup_eta2pipiAlg); then \
	    \rm $(cmt_local_setup_eta2pipiAlg); else \
	    \mv -f $(cmt_local_setup_eta2pipiAlg) $(cmt_final_setup_eta2pipiAlg); fi
...
not_eta2pipiAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(eta2pipiAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
eta2pipiAlgdirs :
	@if test ! -d $(bin)eta2pipiAlg; then $(mkdir) -p $(bin)eta2pipiAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)eta2pipiAlg
else
eta2pipiAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)eta2pipiAlg
#
#$(cmt_local_eta2pipiAlg_makefile) :: $(eta2pipiAlg_dependencies) $(cmt_local_tagfile_eta2pipiAlg) build_library_links dirs eta2pipiAlgdirs
#else
#$(cmt_local_eta2pipiAlg_makefile) :: $(eta2pipiAlg_dependencies) $(cmt_local_tagfile_eta2pipiAlg) build_library_links dirs
#endif
#else
#$(cmt_local_eta2pipiAlg_makefile) :: $(cmt_local_tagfile_eta2pipiAlg)
#endif

ifdef cmt_eta2pipiAlg_has_target_tag

ifndef QUICK
$(cmt_local_eta2pipiAlg_makefile) : $(eta2pipiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building eta2pipiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_extratags) build constituent_config -out=$(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg
else
$(cmt_local_eta2pipiAlg_makefile) : $(eta2pipiAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eta2pipiAlg) ] || \
	  [ ! -f $(cmt_final_setup_eta2pipiAlg) ] || \
	  $(not_eta2pipiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building eta2pipiAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_extratags) build constituent_config -out=$(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg; \
	  fi
endif
...
$(cmt_local_eta2pipiAlg_makefile) : $(eta2pipiAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building eta2pipiAlg.make"; \
	  $(cmtexe) -f=$(bin)eta2pipiAlg.in -tag=$(tags) $(eta2pipiAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg
else
$(cmt_local_eta2pipiAlg_makefile) : $(eta2pipiAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)eta2pipiAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eta2pipiAlg) ] || \
	  [ ! -f $(cmt_final_setup_eta2pipiAlg) ] || \
	  $(not_eta2pipiAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_extratags) build constituent_makefile -out=$(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg

eta2pipiAlg :: $(eta2pipiAlg_dependencies) $(cmt_local_eta2pipiAlg_makefile) dirs eta2pipiAlgdirs
	$(echo) "(constituents.make) Starting eta2pipiAlg"
	@if test -f $(cmt_local_eta2pipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) eta2pipiAlg
	$(echo) "(constituents.make) eta2pipiAlg done"

clean :: eta2pipiAlgclean

eta2pipiAlgclean :: $(eta2pipiAlgclean_dependencies) ##$(cmt_local_eta2pipiAlg_makefile)
	$(echo) "(constituents.make) Starting eta2pipiAlgclean"
	@-if test -f $(cmt_local_eta2pipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) eta2pipiAlgclean; \
	fi
	$(echo) "(constituents.make) eta2pipiAlgclean done"
#	@-$(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) eta2pipiAlgclean

##	  /bin/rm -f $(cmt_local_eta2pipiAlg_makefile) $(bin)eta2pipiAlg_dependencies.make

install :: eta2pipiAlginstall

eta2pipiAlginstall :: $(eta2pipiAlg_dependencies) $(cmt_local_eta2pipiAlg_makefile)
	$(echo) "(constituents.make) Starting install eta2pipiAlg"
	@-$(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) install
	$(echo) "(constituents.make) install eta2pipiAlg done"

uninstall : eta2pipiAlguninstall

$(foreach d,$(eta2pipiAlg_dependencies),$(eval $(d)uninstall_dependencies += eta2pipiAlguninstall))

eta2pipiAlguninstall : $(eta2pipiAlguninstall_dependencies) ##$(cmt_local_eta2pipiAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall eta2pipiAlg"
	@if test -f $(cmt_local_eta2pipiAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_eta2pipiAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall eta2pipiAlg done"

remove_library_links :: eta2pipiAlguninstall
...
#cmt_local_tagfile_config = $(eta2pipiAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(eta2pipiAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)eta2pipiAlg_configsetup.make
...
#cmt_local_tagfile_config = $(eta2pipiAlg_tag).make
cmt_local_tagfile_config = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)eta2pipiAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(eta2pipiAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(eta2pipiAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)eta2pipiAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(eta2pipiAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)eta2pipiAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(eta2pipiAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(eta2pipiAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)eta2pipiAlg_makesetup.make
...
#cmt_local_tagfile_make = $(eta2pipiAlg_tag).make
cmt_local_tagfile_make = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)eta2pipiAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(eta2pipiAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(eta2pipiAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)eta2pipiAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(eta2pipiAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)eta2pipiAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(eta2pipiAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(eta2pipiAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)eta2pipiAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(eta2pipiAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)eta2pipiAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(eta2pipiAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(eta2pipiAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)eta2pipiAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(eta2pipiAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)eta2pipiAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(eta2pipiAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(eta2pipiAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)eta2pipiAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(eta2pipiAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)eta2pipiAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(eta2pipiAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(eta2pipiAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)eta2pipiAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(eta2pipiAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)eta2pipiAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(eta2pipiAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(eta2pipiAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)eta2pipiAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(eta2pipiAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)eta2pipiAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(eta2pipiAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(eta2pipiAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)eta2pipiAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(eta2pipiAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(eta2pipiAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)eta2pipiAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_eta2pipiAlg_check_install_runtime = $(bin)setup_eta2pipiAlg_check_install_runtime$$$$.make
...
eta2pipiAlg_check_install_runtime_extratags = -tag_add=target_eta2pipiAlg_check_install_runtime

#$(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_eta2pipiAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_eta2pipiAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_eta2pipiAlg_check_install_runtime) || \rm -f $(cmt_local_setup_eta2pipiAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_eta2pipiAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_eta2pipiAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_eta2pipiAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_eta2pipiAlg_check_install_runtime) $(cmt_local_setup_eta2pipiAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_eta2pipiAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_eta2pipiAlg_check_install_runtime) $(cmt_final_setup_eta2pipiAlg_check_install_runtime); fi
...
not_eta2pipiAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(eta2pipiAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
eta2pipiAlg_check_install_runtimedirs :
	@if test ! -d $(bin)eta2pipiAlg_check_install_runtime; then $(mkdir) -p $(bin)eta2pipiAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)eta2pipiAlg_check_install_runtime
else
eta2pipiAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)eta2pipiAlg_check_install_runtime
#
#$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) :: $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) build_library_links dirs eta2pipiAlg_check_install_runtimedirs
#else
#$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) :: $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime)
#endif

ifdef cmt_eta2pipiAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) : $(eta2pipiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building eta2pipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime
else
$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) : $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_eta2pipiAlg_check_install_runtime) ] || \
	  $(not_eta2pipiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building eta2pipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) : $(eta2pipiAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building eta2pipiAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)eta2pipiAlg_check_install_runtime.in -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime
else
$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) : $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)eta2pipiAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_eta2pipiAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_eta2pipiAlg_check_install_runtime) ] || \
	  $(not_eta2pipiAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(eta2pipiAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime

eta2pipiAlg_check_install_runtime :: $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) dirs eta2pipiAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting eta2pipiAlg_check_install_runtime"
	@if test -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtime
	$(echo) "(constituents.make) eta2pipiAlg_check_install_runtime done"

clean :: eta2pipiAlg_check_install_runtimeclean

eta2pipiAlg_check_install_runtimeclean :: $(eta2pipiAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_eta2pipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting eta2pipiAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) eta2pipiAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) eta2pipiAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) $(bin)eta2pipiAlg_check_install_runtime_dependencies.make

install :: eta2pipiAlg_check_install_runtimeinstall

eta2pipiAlg_check_install_runtimeinstall :: $(eta2pipiAlg_check_install_runtime_dependencies) $(cmt_local_eta2pipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install eta2pipiAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install eta2pipiAlg_check_install_runtime done"

uninstall : eta2pipiAlg_check_install_runtimeuninstall

$(foreach d,$(eta2pipiAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += eta2pipiAlg_check_install_runtimeuninstall))

eta2pipiAlg_check_install_runtimeuninstall : $(eta2pipiAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_eta2pipiAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall eta2pipiAlg_check_install_runtime"
	@if test -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_eta2pipiAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall eta2pipiAlg_check_install_runtime done"

remove_library_links :: eta2pipiAlg_check_install_runtimeuninstall
